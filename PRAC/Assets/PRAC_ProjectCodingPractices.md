...
- Debug commands should be commented out/deleted when not in use, as they clutter the console and are known to cause a considerable ammount of performance issues.
